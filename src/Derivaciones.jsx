...
const FAMILIAS = [
  {
    ...
    tipos: ["Derivación", "Interconsulta", "Dispositivo", "Pareja", "Infanto-juvenil", "Duelo", "Adicciones", "Grupal", "Adultos", "Familiar", "Trauma", "Ansiedad", "Otro"],
  },
  {
...
export default function Derivaciones({ usuario, esAdmin, chatInicial, onChatInicialUsado, vistaInicial }) {
  ...
  async function publicar() {
    ...
    await addDoc(collection(db, "derivaciones"), {
      especialidad: esp,
      subtipo: esp, // ERROR SOLUCIONADO: Ahora la especialidad alimenta también al subtipo para que funcionen los tags de filtrado
