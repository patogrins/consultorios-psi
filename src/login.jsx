...
export default function Login({ modoOscuro }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: t.bg, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
      ...
      <div style={{ background: t.card, borderRadius: 18, padding: 28, width: "100%", maxWidth: 360, boxShadow: "0 8px 32px rgba(0,0,0,0.12)" }}>
        ...
        {error && (
          <div style={{ background: "#fff5f5", border: "1px solid #fc8181", borderRadius: 8, padding: "8px 12px", marginBottom: 16, fontSize: 12, color: "#c53030", textAlign: "center" }}>
            {error}
          </div>
        )}
        ...
        <button
          onClick={handleLogin}
          disabled={cargando}
          style={{ width: "100%", padding: 12, borderRadius: 10, border: "none", background: cargando ? "#4a5568" : "linear-gradient(135deg,#667eea,#764ba2)", color: "white", fontWeight: 800, fontSize: 14, cursor: cargando ? "not-allowed" : "pointer" }}>
