...
import { collection, onSnapshot, addDoc, updateDoc, deleteDoc, doc, serverTimestamp, runTransaction, setDoc, getDocs, writeBatch } from "firebase/firestore";
...
// ── FOOTER CARTELERA ──────────────────────────────────────────────────────────
function FooterCartelera({ onNueva, onArchivo, onMeInteresa, onMisFichas, esHorizontal=false }) {
  if (esHorizontal) {
...
// ── VISTA ME INTERESA ─────────────────────────────────────────────────────────
function VistaMeInteresa({ archivadas, derivaciones, usuario, onVolver, onQuitarInteres, onAbrirChatGrupal }) {
