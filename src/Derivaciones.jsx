          ...
          <div style={{position:"fixed",inset:0,zIndex:3000,background:"rgba(0,0,0,0.75)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"16px 14px"}}
            ...
            <div onTouchStart={onTouchStart} onTouchMove={onTouchMove} onTouchEnd={onTouchEnd}
              ...
              <div style={{padding:"14px 16px",flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
                ...
                {fichaActual.nota&&<p style={{margin:"0 0 10px",fontSize:12,color:"#e2e8f0",lineHeight:1.5,padding:"8px 10px",background:"rgba(124,106,255,0.06)",borderRadius:10,borderLeft:`2px solid ${fam.color}66`,flexShrink:0,overflow:"hidden",display:"-webkit-box",WebkitLineClamp:3,WebkitBoxOrient:"vertical"}}>&ldquo;{fichaActual.nota}&rdquo;</p>}
